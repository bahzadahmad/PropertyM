      ...
      <div class="row mb-2">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-left">
              ...
              <li class="breadcrumb-item active">Client From</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h4 class="card-title float-left">Client Form</h4>
                <a href="{{ route('client') }}" class="btn btn-primary btn-sm" style="float: right;">Back</a>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
